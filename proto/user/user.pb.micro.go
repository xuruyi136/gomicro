...
type UserService interface {
	UserRegistry(ctx context.Context, in *UserRegistryRequest, opts ...client.CallOption) (*UserLoginResponse, error)
...
func (c *userService) UserRegistry(ctx context.Context, in *UserRegistryRequest, opts ...client.CallOption) (*UserLoginResponse, error) {
	req := c.c.NewRequest(c.name, "User.UserRegistry", in)
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		UserRegistry(ctx context.Context, in *UserRegistryRequest, out *UserLoginResponse) error
...
func (h *userHandler) UserRegistry(ctx context.Context, in *UserRegistryRequest, out *UserLoginResponse) error {
	return h.UserHandler.UserRegistry(ctx, in, out)
}
